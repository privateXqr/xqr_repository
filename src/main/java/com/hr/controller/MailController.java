...
//        }
        ...
        if (mailAccount == null || "".equals(mailAccount)) {   //内部邮件
            ...
            // 收件人电子邮箱
            String to = mailAccount;

            // 发件人电子邮箱
            String from = "842559938@qq.com";
            ...
            Session session2 = Session.getInstance(properties, new Authenticator() {
                public PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("842559938@qq.com", "xcjhdugnthhlbeic");
                }
            });
            ...
            try {
                ...
                // Set Subject: 头部头字段
                message.setSubject(aoaInMailList.getMailTitle());

                // 设置消息体
                message.setText(aoaInMailList.getMailContent());
